    ...
    return (
        <section className='aboutMe' id='aboutMe' itemscope itemtype="https://schema.org/Person">
            ...
            <div className="aboutMe__text">
                <h1>Bonjour, je suis <span itemprop="givenName">Caroline</span> <span itemprop="familyName" >Lopez</span>, <span itemprop="jobTitle">développeuse front-end junior</span> près de <span itemprop="homeLocation">Lyon</span>, bienvenue dans mon univers !</h1>
